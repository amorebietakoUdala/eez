...
class table extends Controller {
    ...
    connect() {
        window.optionFormatter = this.optionFormatter;
        console.log('Connecting table');
        console.log(this.hasTableTarget);
    ...
    onEdit(e) {
        const selection = this.$table.bootstrapTable('getSelections');
    ...
    optionFormatter(value, row) {
        console.log(row, value);
        const htmlOptions = `<a href="{{ path ("quota_show",{'quota': quota.id })}}" data-action="click->table#onClick" data-pagination="false">
        <i class="fa fa-eye"></i>
     </a>
