...
const TurboHelper = class {
    constructor() {
        document.addEventListener('turbo:before-cache', (e) => {
            console.log('Before cache fired!!!');
            console.log(e);
            this.closeModal();
    ...
    destroyBootstrapTable() {
        const tableDiv = document.querySelector('div.bootstrap-table');
        if ( tableDiv != null ) {
            console.log(tableDiv.children);
            const table = document.querySelector('table.bootstrap-table');
            console.log(table);
            const insertPoint = tableDiv.parentElement;
            insertPoint.insertBefore(table, insertPoint.children[0]);
            console.log(insertPoint);
            tableDiv.remove();
            console.log('After remove table div');
            console.log(insertPoint.children);
        } else {
